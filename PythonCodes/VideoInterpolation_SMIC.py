...
if __name__ == '__main__':
    ...
    image_root = r"B:\0_0NewLife\datasets\SMIC\HS_raw"  # SMIC
    out_dir = f"B:\\0_0NewLife\\0_Papers\\FGRMER\\SMIC\\Interpolation\\Inter_offset_{parallel}"
